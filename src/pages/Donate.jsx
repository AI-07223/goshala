      ...
      <div className="bg-stone-50 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-serif font-bold text-stone-800 mb-6">Make a Difference</h1>
            <p className="text-xl text-stone-600">Your contribution directly saves lives.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <h2 className="text-2xl font-bold text-stone-800 mb-6">Choose Your Impact</h2>
              ...
              <div className="mt-8 pt-6 border-t border-stone-100">
                <label className="block text-sm font-medium text-stone-500 mb-2">Custom Amount (₹)</label>
                <input
                  type="number"
                  value={amount}
            ...
            >
              ...
              <div className="bg-orange-600 text-white p-8 rounded-2xl shadow-xl text-center relative overflow-hidden">
                ...
                <h3 className="text-xl font-bold mb-6">Scan to Donate via UPI</h3>
                ...
                <p className="text-sm opacity-80">Supports GPay, PhonePe, Paytm</p>
              </div>

              {/* Bank Details */}
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-stone-100">
                <h3 className="text-lg font-bold text-stone-800 mb-4">Bank Transfer Details</h3>
